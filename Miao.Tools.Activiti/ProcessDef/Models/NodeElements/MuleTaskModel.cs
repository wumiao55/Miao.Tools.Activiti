...
{
    /// <summary>
    /// xml element: serviceTask, type:mule
    /// </summary>
    public class MuleTaskModel : BPMNNodeElementModel
    {
        private static readonly string _elementName = "serviceTask";
        private static readonly string _type = "mule";

        /// <summary>
        /// 构造方法
        /// </summary>
        public MuleTaskModel()
        {
        ...
        public MuleTaskModel SetDocumentation(string documentation)
        {
        ...
        public MuleTaskModel SetMultiInstanceLoopCharacteristics(MultiInstanceLoopCharacteristicsModel multiInstanceLoopCharacteristics)
        {
        ...
        /// <returns></returns>
        public MuleTaskModel AddActivitiFields(params ActivitiFieldModel[] activitiFields)
        {
